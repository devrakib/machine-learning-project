...
# Install + load packages for decision trees and random forests
...
predict7 <- data.frame(PassengerId = test$PassengerId, Survived = MyPredict)
write.csv(predict7, file = "prediction7.csv", row.names = FALSE)